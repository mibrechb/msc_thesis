...
var l7_filt = ee.ImageCollection("LANDSAT/LE07/C02/T1_L2")
  .filterBounds(roi)
  .filterDate(start, end)
  .map(addDate)

// Get all times from scenes and convert them to date string
var L7_dateList = l7_filt.aggregate_array('date')

// Output usable S-1 imagecollection and available dates
print('Usable L7 Collection:', l7_filt)
print('Available L7 dates:', L7_dateList)
...
var coarseClassification_filt = coarseClassification
  .sort('date')
  .filter(ee.Filter.inList('date', L7_dateList))
